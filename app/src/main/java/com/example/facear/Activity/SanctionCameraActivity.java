...
public class SanctionCameraActivity extends AppCompatActivity implements View.OnClickListener{
    private CameraPreview cameraPreview;
    private ImageView btnCapture,btnFlash,btnBack;
    private TextView txtMessage,txtTitle,txtErrorMessage,txtDocType,txtCountry,topTitle;
    ...
    String imgFileName,imgFilePath,CardType,DocType;
    File imgFile;
    File demoFile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sanction_camera);

        BackgroundService.mContext = SanctionCameraActivity.this;
        init();
        listener();
        ...
        if (CardType.equals("Passport")){
            ...
            DocType = "FrontIDCard";
        }else if (CardType.equals("DrivingLicense")){
            DocType = "FrontDriving";
        }else if (CardType.equals("ResidentPermit")){
            DocType = "FrontResident";
        }
        ...
        if (DocType.equals("Passport")){
            txtMessage.setText("Please place the Passport inside the Frame and take the photo");
            txtDocType.setText("Passport");
            topTitle.setText("Passport");
        }else if (DocType.equals("FrontIDCard")){
            txtMessage.setText("Place the front page of ID Card inside the Frame and take the photo");
            txtDocType.setText("Front of ID Card");
            topTitle.setText("ID Card");
        }else if (DocType.equals("FrontDriving")){
            txtMessage.setText("Place the front page of Driving License inside the Frame and take the photo");
            txtDocType.setText("Front of Driving License");
            topTitle.setText("Driving License");
        }else if (DocType.equals("FrontResident")){
            txtMessage.setText("Place the front page of Resident Permit inside the Frame and take the photo");
            txtDocType.setText("Front of Resident Permit");
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (demoBitmap != null){
                                ...
                                String imgDemoFilePath = SanctionCameraActivity.this.getFilesDir().getPath().toString() + "/" + demoImageFileName;
...
//                                    imgCrop.setImageBitmap(demoBitmap);
                                ...
                                Toast.makeText(SanctionCameraActivity.this, "Id card capture was failed", Toast.LENGTH_LONG).show();
                            }
                        }
                    });
                } else {
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btnTake:
                ...
                imgFilePath = SanctionCameraActivity.this.getFilesDir().getPath().toString() + "/" + imgFileName;
                ...
                try {
                    ...
                    if (DocType.equals("Passport")){
                        AppConstants.PassportSanctionPath = imgFilePath;
                        Intent intent = new Intent(SanctionCameraActivity.this, IDDocMainActivity.class);
                        intent.putExtra("Target","SanctionsPEP");
                        startActivity(intent);
                    }else if (DocType.equals("FrontIDCard")){
                        AppConstants.IDCardSanction_frontPath = imgFilePath;
                        ...
                        DocType = "BackIDCard";
                        txtDocType.setText("Back of ID Card");
                        txtMessage.setText("Place the back page of ID Card inside the Frame and take the photo");
                    }else if (DocType.equals("FrontDriving")){
                        AppConstants.DrivingSanction_frontPath = imgFilePath;
                        cameraRelative.setVisibility(View.VISIBLE);
                        cropRelative.setVisibility(View.GONE);
                        btnCapture.setVisibility(View.VISIBLE);
                        btnRetake.setVisibility(View.GONE);
                        ...
                        txtMessage.setVisibility(View.VISIBLE);
                        DocType = "BackDriving";
                        txtDocType.setText("Back of Driving License");
                        txtMessage.setText("Place the back page of Drving License inside the Frame and take the photo");
                    }else if (DocType.equals("FrontResident")){
                        AppConstants.ResidentSanction_frontPath = imgFilePath;
                        cameraRelative.setVisibility(View.VISIBLE);
                        cropRelative.setVisibility(View.GONE);
                        btnCapture.setVisibility(View.VISIBLE);
                        btnRetake.setVisibility(View.GONE);
                        ...
                        txtTitle.setText("Powered by BIOMID");
                        txtMessage.setVisibility(View.VISIBLE);
                        DocType = "BackResident";
                        txtDocType.setText("Back of Resident Permit");
                        txtMessage.setText("Place the back page of Resident Permit inside the Frame and take the photo");
                    }else if (DocType.equals("BackIDCard")){
                        AppConstants.IDCardSanction_backPath = imgFilePath;
                        Intent intent = new Intent(SanctionCameraActivity.this, IDDocMainActivity.class);
                        intent.putExtra("Target","SanctionsPEP");
                        startActivity(intent);
                    }else if (DocType.equals("BackDriving")){
                        AppConstants.DrivingSanction_backPath = imgFilePath;
                        Intent intent = new Intent(SanctionCameraActivity.this, IDDocMainActivity.class);
                        intent.putExtra("Target","SanctionsPEP");
                        startActivity(intent);
                    }else if (DocType.equals("BackResident")){
                        AppConstants.ResidentSanction_backPath = imgFilePath;
                        Intent intent = new Intent(SanctionCameraActivity.this, POADocumentActivity.class);
                        startActivity(intent);
                    }
            ...
            case R.id.btnRetake:
                ...
                txtCountry.setVisibility(View.VISIBLE);
                txtMessage.setVisibility(View.VISIBLE);
                txtDocType.setVisibility(View.GONE);
                ...
                if (DocType.equals("Passport")){
                    ...
                    txtMessage.setText("Place the front page of Drving License inside the Frame and take the photo");
                }else if (DocType.equals("FrontResident")){
                    txtMessage.setText("Place the front page of Resident Permit inside the Frame and take the photo");
                }else if (DocType.equals("BackIDCard")){
                    txtMessage.setText("Place the back page of ID Card inside the Frame and take the photo");
                }else if (DocType.equals("BackDriving")){
                    txtMessage.setText("Place the back page of Driving License inside the Frame and take the photo");
                }else if (DocType.equals("BackResident")){
                    txtMessage.setText("Place the back page of Resident Permit inside the Frame and take the photo");
                }
                break;
    ...
    private void AuthenticationToServer() {
        String api_key = Preferences.getValue_String(SanctionCameraActivity.this, Preferences.API_Key);
        String secret_key = Preferences.getValue_String(SanctionCameraActivity.this, Preferences.API_SecretKey);
//        loadingDialog = new LoadingDialog(IDDocCameraActivity.this, false);
        if (CoreApp.isNetworkConnection(SanctionCameraActivity.this)) {
            ...
            call.enqueue(new Callback<AuthenticationResponse>() {
                ...
                public void onResponse(Call<AuthenticationResponse> call, Response<AuthenticationResponse> response) {
                    ...
                    if (statuscode == 200) {
                        ...
                        Toast.makeText(SanctionCameraActivity.this, response.message(), Toast.LENGTH_LONG).show();
                    }
                }
                @Override
                public void onFailure(Call<AuthenticationResponse> call, Throwable t) {
                    Toast.makeText(SanctionCameraActivity.this, "Server is not working now", Toast.LENGTH_LONG).show();
//                    loadingDialog.hide();
                }
            });
        } else {
//            loadingDialog.hide();
            Toast.makeText(SanctionCameraActivity.this, "No internet connection available", Toast.LENGTH_LONG).show();
        }
    }
